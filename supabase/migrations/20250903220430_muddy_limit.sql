/*
  # Pillar 1: Core Inventory Management Schema

  ## Overview
  This migration establishes the foundational database schema for the inventory management system.
  It implements the core tables for product catalog, locations, and inventory tracking with 
  dual unit management (bottles vs milliliters).

  ## Tables Created
  1. **ubicaciones** - Physical locations where inventory is stored
  2. **productos** - Master catalog of products, ingredients, and recipes  
  ...
  - Can be refined later for role-based access
*/
...
CREATE INDEX idx_productos_id_externo ON public.productos(id_producto_externo);
